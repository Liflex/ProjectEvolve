# AutoResearch Experiment 48/1045
...
- Если в диалоговом окне вводить Ctrl+F, то не вылезает задуманное окно поиска, а вылезает стандартное от браузера
