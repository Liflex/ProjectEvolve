...
- **Цель частично выполнена** — уточни формулировку (сократи, укажи что осталось)
- **Цель неактуальна** — убери
- **Новая цель обнаружена** — добавь в конец массива

**Как обновить:** прочитай `.autoresearch.json`, измени поле `"goals"`, запиши обратно. JSON формат обязательно.
